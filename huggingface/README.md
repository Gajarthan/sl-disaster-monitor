...
`id`, `source`, `document_type`, `hazard`, `hazards`, `severity`, `title`, `description`, `summary`, `language`, `language_confidence`, `language_reason`, `issued_at`, `valid_from`, `valid_until`, `districts`, `provinces`, `source_page`, `source_pdf`, `content_hash`, `processed_at`.
